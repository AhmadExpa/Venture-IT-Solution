...
const TechStackMethod = () => {
  return (
    <section className="w-full bg-[#F2F2F7] px-10">
      <div className="max-w-7xl mx-auto md:px-4  px-0 lg:py-5 ">
        <div className="max-w-8xl">
          <h2 className="lg:text-[90px] md:text-[50px] text-[30px]  font-bold text-gray-900 md:mb-5">
      ...
      <div className="max-w-7xl mx-auto md:px-4 px-0">
        ...
        <div className="flex flex-wrap md:gap-8 gap-3 md:justify-start justify-center">
      ...
      <div className="max-w-7xl mx-auto md:px-4 px-0 py-4 md:py-10">
        <div className="md:mb-12">
          <h2 className="md:text-4xl text-2xl font-bold text-gray-900 md:mb-2">
...
export default TechStackMethod;
