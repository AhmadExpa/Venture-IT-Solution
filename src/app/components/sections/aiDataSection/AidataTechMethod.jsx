...
const AidataTechMethod = () => {
  return (
    <section className="w-full bg-[#F2F2F7] px-10">
      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
        <div className="mb-12">
          <h2 className="md:text-4xl text-2xl font-bold text-gray-900 mb-2">Databases</h2>
          <p className="text-lg text-gray-600">
      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
        <div className="mb-12">
          <h2 className="md:text-4xl text-2xl font-bold text-gray-900 mb-2">Testing</h2>
...
export default AidataTechMethod;
