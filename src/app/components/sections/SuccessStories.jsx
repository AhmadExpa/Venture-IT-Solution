...
function IndustriesClientSay() {
  const testimonialData = [
    ...
    {
      testimonialText:
        "“We’ve hired the Venture IT Solution’s team to build a web-based app from scratch using React and .NET. They have been very cooperative and efficient, ensuring effective workflow. Their personalized approach and positive attitude are surely the hallmarks of their work.” — Robert.",
    },
    {
      testimonialText:
  ...
  return (
    <CustomTestimonial
      ...
      description="We love growing with our partners and customers. Discover how we continuously helped businesses accelerate for long-term success and trusted collaboration."
