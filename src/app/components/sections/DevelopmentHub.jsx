...
const articles = [
  {
    items: [
      {
        image: img2,
        title: "The Future of IoT: How Connected Devices Are Reshaping Industries",
      },
      {
        image: img3,
        title: "AI in IT Services: Revolutionizing Automation and Decision Making",
      },
    ],
  },
  {
    items: [
      {
        image: img4,
        title: "The Rise of Robotics: Enhancing Efficiency in Digital Transformation",
      },
      {
        image: img5,
