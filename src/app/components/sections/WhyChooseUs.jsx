...
// const featuresData = [
//   { number: "1", title: "Full-Stack Mastery", description: "Our comprehensive skill set covers every aspect of web development, ensuring a seamless process." },
//   { number: "2", title: "Agile at Heart", description: "We embrace flexibility and rapid iteration to deliver value quickly." },
//   { number: "3", title: "Security First", description: "Your data is our priority. We implement robust security measures to protect your digital assets." },
//   { number: "4", title: "Proven Track Record", description: "Our portfolio showcases a history of successful projects and satisfied clients." },
//   { number: "5", title: "Client-Centric Approach", description: "We collaborate closely to understand your vision and deliver tailored solutions." },
//   { number: "6", title: "Dedicated Teams", description: "Our expert teams are committed to your project's success." },
// ];
  ...
  return (
    <div className="w-full bg-gray-50 py-16 px-2 md:px-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl md:text-4xl px-4 font-bold text-center mb-6">
          Why Choose{" "}
