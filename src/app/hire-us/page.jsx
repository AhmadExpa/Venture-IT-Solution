...
//       {toast.show && (
//         <div
//           className={`fixed  top-4 -right-36 transform -translate-x-1/2 z-50 px-4 py-3 rounded-lg shadow-lg ${
...
const Page = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.businessEmail) {
      ...
      newErrors.businessEmail = "Please enter a valid email address (e.g., example@domain.com)";
    }
